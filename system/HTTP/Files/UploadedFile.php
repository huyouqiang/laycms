...
class UploadedFile extends File implements UploadedFileInterface
{
    ...
    /**
     * The error constant of the uploads
     ...
     * @param int|null    $error        The error constant of the uploads (one of PHP's UPLOADERRXXX constants)
     ...
     * used to ensure permissions and uploads status are verified correctly.
     *
    ...
    /**
     * Returns the name of the file as provided by the client during uploads.
     */
     ...
     *
     * By default, uploads files are saved in writable/uploads directory. The YYYYMMDD folder
