...
<body>
    ...
    <div class="login-right">
        ...
        <?php if($errors->any()): ?>
        <div class="alert alert-danger py-2 mb-3"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
        <form class="login-form" action="<?php echo e(route('login')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                <label class="form-label">用户名</label>
                <input type="text" name="username" class="form-control" value="<?php echo e(old('username')); ?>" placeholder="请输入用户名" required autofocus>
            </div>
            <div class="mb-4">
