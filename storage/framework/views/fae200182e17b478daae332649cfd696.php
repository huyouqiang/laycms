...
<body>
    <div class="login-wrap">
        ...
        <div class="login-right">
            ...
            <?php if($errors->any()): ?>
            <div class="layui-elem-quote layui-quote-nm layui-bg-red" style="margin-bottom:15px;"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            <form class="layui-form login-form" action="<?php echo e(route('login')); ?>" method="POST" style="margin-top:20px;">
                <?php echo csrf_field(); ?>
                <div class="layui-form-item">
                    <label class="layui-form-label">用户名</label>
                    <div class="layui-input-block">
                        <input type="text" name="username" required lay-verify="required" placeholder="请输入用户名" value="<?php echo e(old('username')); ?>" class="layui-input" autofocus>
                    </div>
                </div>
                <div class="layui-form-item">
